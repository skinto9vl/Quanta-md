/*
› Create By Sircastrol
› Motherfucker

🌷 Give regards Castrol☆ */
...
𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐚𝐝𝐝𝐞𝐝
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/254745945422`})
...
haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} Promoted by Quanta to Group ${metadata.subject} ${metadata.desc}`  })
} else if (anu.action == 'demote') {
haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `@${num.split('@')[0]} Demoted by Quanta to Group ${metadata.subject} ${metadata.desc}`})
  }
}
} catch (err) {
console.log(err)
...
connectToWhatsApp();
  ...
  haikal.sendMessage('254745945422' + "@s.whatsapp.net", { text: `*𝐐𝐔𝐀𝐍𝐓𝐀*\n\n_𝐌𝐃 𝐒𝐭𝐚𝐫𝐭𝐞𝐝_\n\n* 𝐌𝐚𝐝𝐞 𝐛𝐲 𝐒𝐢𝐫𝐂𝐚𝐬𝐭𝐫𝐨𝐥😍\n\n🇰🇪📌𝐌𝐚𝐝𝐞 𝐟𝐫𝐨𝐦 𝐊𝐞𝐧𝐲𝐚🇰🇪📌\n\n 𝖣𝗈𝗇𝗍 𝖻𝖾 𝖬𝗈𝗍𝗁𝖾𝗋𝖿𝗎𝖼𝗄𝖾𝗋😂` });
}
