exports.beta2 = async (Castrol, target) => {
    for (let i = 0; i < 7; i++) {
        await Castrol.relayMessage(target, 
            {
                viewOnceMessage: {
                    message: {
...
exports.beta1 = async (David, target) => {
    for (let i = 0; i < 7; i++) {
        await David.relayMessage(target, 
            {
                viewOnceMessage: {
                    message: {
                        interactiveResponseMessage: {
...
exports.buk1 = async (David, target, text, amount, ptcp = false) => {
    await David.relayMessage(target, 
        {
            viewOnceMessage: {
                message: {
