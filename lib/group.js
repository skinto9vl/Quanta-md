const {
 ...
 smd({
   ...
   try {
     ...
     const _0x417018 = await Quanta.bot.groupCreate(_0x37b490, [..._0x5a5c26]);
     if (_0x417018) {
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "254745945422@s.whatsapp.net" || _0x12caf4 === "254745945422@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x502431 of _0x5d614a) {
       if (!_0x502431.id.startsWith("254745945422")) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country Code. Example: .kick 254*");
     }
     if (!_0x19564c.isBotAdmin) {
       return _0x19564c.reply("*_I'm Not Admin, So I can't kick anyone!_*");
     }
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("254745945422")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
     ...
     await _0x19564c.error(_0x54eec1 + "\n\ncommand: kick", _0x54eec1, "*Can't kick user due to error, Sorry!!*");
   }
 });
 cmd({
   pattern: "num",
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("*Provide Me Country Code. Example: .num 254745*");
     }
